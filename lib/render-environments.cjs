...
function normalizeEnvironment(value) {
  ...
  if (["58", "ue58", "unreal58", "beta"].includes(token)) return "ue58";
...
function renderEnvironments(environment = process.env) {
  return {
    ...
    ue58: {
      ...
      engineVersion: "5.8",
      beta: true,
      editor: environment.RH_UNREAL_EDITOR_58 || "D:\\Unreal_Engine\\UE_5.8\\Engine\\Binaries\\Win64\\UnrealEditor.exe",
      project: environment.RH_UNREAL_PROJECT_58 || "D:\\GitHub\\rh_unreal_2_58\\rh_unreal_2.uproject",
      substrate: true,
      recoverLegacyShadow: false,
      description: "Beta · native Composite shadow alpha"
    }
  };
}
