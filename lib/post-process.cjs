...
module.exports = {
  DEFAULT_CONFIG, availability, imageLayer, isProcessedImage, loadConfig, metadataFor, originalFilesForJob,
  pngDimensions, processImage, processJob, processedPathFor, resolveVips, taskForFile, writePngText
};
