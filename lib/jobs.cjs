...
module.exports = { CAMERA_YAW, SOFA_CAMERA_YAW, PRODUCT_TYPES, productType, RESOLUTIONS, RESOLUTION_PROFILES, renderProfile, cropMode, buildJob, buildBatchJob, writeJob, writeBatchJob, groupedMaterials, fabricFileNameFormat };
